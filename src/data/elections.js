...
export const elections = [
  ...
  // ── fr_2027 ─────────────────────────────────────────────────────────────
  {
    ...
    year: 2027,
    description: {
      en: `France will elect a new president in spring 2027. Emmanuel Macron cannot stand again. Jordan Bardella leads polls after Marine Le Pen's ineligibility conviction. Jean-Luc Mélenchon has declared his candidacy.`,
      fr: `La France élira un nouveau président au printemps 2027. Emmanuel Macron ne peut pas se représenter. Jordan Bardella domine les sondages après la condamnation à l'inéligibilité de Marine Le Pen. Jean-Luc Mélenchon a déclaré sa candidature.`,
    },
    context: {
      en: [
        ...
        `With Macron unable to stand, the race is unusually open. Jordan Bardella (RN) leads polls at ~32% after Marine Le Pen was convicted and declared ineligible in March 2025 (appeal verdict: July 7, 2026). Jean-Luc Mélenchon officially declared his fourth presidential run in late May 2026. A left-wing primary is scheduled for October 11, 2026, though both Mélenchon and Glucksmann have refused to participate.\n\n⚠ Candidacy statuses as of June 2026. "Probable" = publicly positioning but not officially declared. "Speculative" = plausible but unconfirmed.`,
      ],
      fr: [
    ...
    deeperContext: {
      ...
      fr: [
        `Le centre macroniste s'est affaibli après deux mandats. Ses deux héritiers — Attal (Premier ministre en 2024) et Philippe (Premier ministre 2017–2020) — risquent de diviser le vote centriste. Jordan Bardella est désormais le candidat naturel du RN après la condamnation de Le Pen. La gauche cherche à se rassembler autour d'une candidature commune lors d'une primaire le 11 octobre 2026.`,
    ...
    candidates: [
      {
        ...
        result: { en: `Ineligible — convicted March 2025 (appeal: July 7, 2026)`, fr: `Inéligible — condamnée mars 2025 (appel : 7 juillet 2026)` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 95, SECURITY: 88, ENVIRONMENT: 25, DEMOCRACY: 40, GLOBAL: 22, PUBLIC_SERVICES: 52 },
        description: { en: `Far-right nationalist. Convicted in March 2025 for embezzlement of EU funds and sentenced to 5 years of ineligibility with immediate enforcement — barring her from the 2027 race unless overturned on appeal (verdict: July 7, 2026). RN has shifted to Bardella. Very anti-immigration, socially conservative, economically statist on purchasing power.`, fr: `Nationaliste d'extrême droite. Condamnée en mars 2025 pour détournement de fonds européens, avec 5 ans d'inéligibilité à exécution provisoire immédiate — elle ne peut pas se présenter en 2027 sauf si sa peine est annulée en appel (verdict : 7 juillet 2026). Le RN s'est reporté sur Bardella. Très anti-immigration, conservatrice socialement, statiste sur le pouvoir d'achat.` },
      },
      {
        id: `philippe`,
      ...
      },
      {
        ...
        color: `#003189`,
        candidacyStatus: `declared`,
        result: { en: `RN candidate — leading polls (~32%)`, fr: `Candidat RN — en tête des sondages (~32%)` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 96, SECURITY: 88, ENVIRONMENT: 22, DEMOCRACY: 38, GLOBAL: 14, PUBLIC_SERVICES: 58 },
        description: { en: `RN president and primary 2027 candidate. More radical than Le Pen on immigration and sovereignty; dropped Frexit but remains the most eurosceptic major candidate. Le Pen's conviction left him as the de facto RN standard-bearer — he leads all polls at ~32% (June 2026).`, fr: `Président du RN et candidat principal pour 2027. Plus radical que Le Pen sur l'immigration et la souveraineté ; a abandonné le Frexit mais reste le candidat major le plus eurosceptique. La condamnation de Le Pen en fait le candidat naturel du RN — il domine tous les sondages à ~32% (juin 2026).` },
      },
      {
        id: `castets`,

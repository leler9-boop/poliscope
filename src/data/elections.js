...
export const elections = [
  ...
  // ── paris_2026 ───────────────────────────────────────────────────────────
  {
    ...
    year: 2026,
    description: {
      en: `In November 2024, Anne Hidalgo announced she would not seek a third term. The March 2026 election opened with a renewed field: Emmanuel Grégoire (PS) led a unified left coalition, Rachida Dati (LR) led the right, and Sophia Chikirou ran for LFI. First round (15 March 2026): Grégoire 37.98%, Dati 25.46%, Chikirou 11.72%, Bournazel (Horizons) 11.34%.`,
      fr: `En novembre 2024, Anne Hidalgo a annoncé qu'elle ne briguerait pas un troisième mandat. Les municipales de mars 2026 s'ouvrent sur un renouvellement : Emmanuel Grégoire (PS) conduit une union de la gauche, Rachida Dati (LR) porte la droite, Sophia Chikirou représente LFI. 1er tour (15 mars 2026) : Grégoire 37,98 %, Dati 25,46 %, Chikirou 11,72 %, Bournazel (Horizons) 11,34 %.`,
    },
    context: {
      en: [
        ...
        `Emmanuel Grégoire (PS) served as First Deputy Mayor under Hidalgo and is seen as continuing her legacy while promising on cleanliness and housing. Rachida Dati (LR) ran on security, business competitiveness, and reversing car restrictions. Sophia Chikirou (LFI) pushed hard on housing and inequality. Pierre-Yves Bournazel (Horizons) placed 4th and subsequently withdrew, endorsing Dati for the second round.`,
      ],
      fr: [
        ...
        `Emmanuel Grégoire (PS) était premier adjoint d'Hidalgo. Il incarne la continuité tout en promettant des améliorations sur la propreté et le logement. Rachida Dati (LR) a centré sa campagne sur la sécurité, la compétitivité économique et l'assouplissement des restrictions de circulation. Sophia Chikirou (LFI) a mis en avant le logement et les inégalités. Pierre-Yves Bournazel (Horizons) a terminé 4e puis s'est désisté en faveur de Dati pour le second tour.`,
      ],
    },
    deeperContext: {
      en: [
    ...
    candidates: [
      {
        ...
        color: `#E75480`,
        result: { en: `1st round: 37.98%`, fr: `1er tour : 37,98 %` },
        profile: { ECONOMY: 28, SOCIAL: 82, IMMIGRATION: 22, SECURITY: 40, ENVIRONMENT: 70, DEMOCRACY: 80, GLOBAL: 22, PUBLIC_SERVICES: 80 },
        description: { en: `First Deputy Mayor under Hidalgo 2014–2026. Led a unified PS+Greens+PCF list. Pledged 30,000 new social housing units, maintained cycling agenda, improved cleanliness.`, fr: `Premier adjoint d'Hidalgo de 2014 à 2026. Conduit une liste d'union PS+Verts+PCF. A promis 30 000 nouveaux logements sociaux, maintenu l'agenda vélo, et amélioré la propreté.` },
      },
      {
        id: `dati`,
        ...
        party: { en: `Les Républicains`, fr: `Les Républicains` },
        color: `#0066CC`,
        result: { en: `1st round: 25.46%`, fr: `1er tour : 25,46 %` },
        profile: { ECONOMY: 65, SOCIAL: 38, IMMIGRATION: 62, SECURITY: 78, ENVIRONMENT: 38, DEMOCRACY: 70, GLOBAL: 40, PUBLIC_SERVICES: 40 },
        description: { en: `Mayor of the 7th arrondissement since 2008, former Justice Minister. Conservative platform: triple the municipal police, restore parking, cut municipal debt, revise car restrictions.`, fr: `Maire du 7e arrondissement depuis 2008, ancienne ministre de la Justice. Programme conservateur : tripler la police municipale, rétablir des places de stationnement, réduire la dette, réviser les restrictions de circulation.` },
      },
      {
        id: `chikirou_paris`,
        ...
        party: { en: `La France Insoumise`, fr: `La France Insoumise` },
        color: `#CC2200`,
        result: { en: `1st round: 11.72%`, fr: `1er tour : 11,72 %` },
  ...
  // ── stras_2026 ───────────────────────────────────────────────────────────
  {
    ...
    year: 2026,
    description: {
      en: `In March 2026, Strasbourg elected its city council in a four-way race. Incumbent mayor Jeanne Barseghian (EELV) faced a strong challenge from the left (Trautmann, PS) and the right (Vetter, LR/UDI). First round (15 March 2026): Trautmann 25.93%, Vetter 24.23%, Barseghian 19.72%, Kobryn (LFI) 12.03%. After the first round, Barseghian and Kobryn announced a left-wing alliance for the second round.`,
      fr: `En mars 2026, Strasbourg a élu son conseil municipal dans une quadrangulaire. La maire sortante Jeanne Barseghian (EELV) a fait face à une forte concurrence de la gauche (Trautmann, PS) et de la droite (Vetter, LR/UDI). 1er tour (15 mars 2026) : Trautmann 25,93 %, Vetter 24,23 %, Barseghian 19,72 %, Kobryn (LFI) 12,03 %. Après le premier tour, Barseghian et Kobryn ont annoncé une union de la gauche pour le second tour.`,
    },
    context: {
      en: [
        ...
        `Catherine Trautmann (PS) returned to local politics as the leading left-pluralist candidate, drawing on her experience as former mayor and MEP. Jean-Philippe Vetter (LR/UDI) ran as the main right-of-centre candidate on a platform of public order and economic competitiveness. Barseghian defended her ecological record and sought to build a broader left coalition for the second round with Florian Kobryn (LFI).`,
      ],
      fr: [
        ...
        `Catherine Trautmann (PS) est revenue en politique locale comme principale candidate de la gauche plurielle, s'appuyant sur son expérience d'ancienne maire et eurodéputée. Jean-Philippe Vetter (LR/UDI) a conduit la droite sur un programme d'ordre public et de compétitivité économique. Barseghian a défendu son bilan écologique et cherché à construire une union de la gauche pour le second tour avec Florian Kobryn (LFI).`,
      ],
    },
    deeperContext: {
      en: [
    ...
    candidates: [
      {
        ...
        party: { en: `Parti Socialiste`, fr: `Parti Socialiste` },
        color: `#E75480`,
        result: { en: `1st round: 25.93%`, fr: `1er tour : 25,93 %` },
        profile: { ECONOMY: 30, SOCIAL: 80, IMMIGRATION: 25, SECURITY: 45, ENVIRONMENT: 60, DEMOCRACY: 78, GLOBAL: 18, PUBLIC_SERVICES: 78 },
        description: { en: `Former Mayor of Strasbourg (1989–2001) and MEP. Ran a centre-left platform: defend the European Parliament seat, targeted policing with social investment, phased tram extension, pragmatic housing policy.`, fr: `Ancienne maire de Strasbourg (1989–2001) et eurodéputée. Programme centre-gauche : défendre le siège du Parlement européen, police ciblée couplée à l'investissement social, prolongement progressif du tram, politique du logement pragmatique.` },
      },
      {
        id: `vetter_stras`,
        ...
        color: `#0066CC`,
        result: { en: `1st round: 24.23%`, fr: `1er tour : 24,23 %` },
      ...
      },
      {
        ...
        party: { en: `Les Écologistes (EELV)`, fr: `Les Écologistes (EELV)` },
        color: `#00A550`,
        result: { en: `1st round: 19.72% — allied with Kobryn (LFI) for 2nd round`, fr: `1er tour : 19,72 % — alliée avec Kobryn (LFI) pour le 2e tour` },
        profile: { ECONOMY: 22, SOCIAL: 82, IMMIGRATION: 20, SECURITY: 28, ENVIRONMENT: 90, DEMOCRACY: 82, GLOBAL: 20, PUBLIC_SERVICES: 75 },
        description: { en: `Incumbent mayor (2020–2026). Green ecologist. Reduced city-centre parking, expanded cycling infrastructure, increased social housing construction. Sought re-election at the head of a left alliance with LFI.`, fr: `Maire sortante (2020–2026). Écologiste. A réduit le stationnement en centre-ville, développé les pistes cyclables, augmenté la construction de logements sociaux. S'est représentée à la tête d'une alliance de gauche avec LFI.` },
      },
      {
        id: `kobryn_stras`,
        ...
        party: { en: `La France Insoumise`, fr: `La France Insoumise` },
        color: `#CC2200`,
        result: { en: `1st round: 12.03% — withdrew, allied with Barseghian for 2nd round`, fr: `1er tour : 12,03 % — désisté, allié avec Barseghian pour le 2e tour` },
        profile: { ECONOMY: 15, SOCIAL: 90, IMMIGRATION: 15, SECURITY: 20, ENVIRONMENT: 78, DEMOCRACY: 88, GLOBAL: 20, PUBLIC_SERVICES: 90 },
        description: { en: `LFI candidate. Far-left platform: expand public services, oppose austerity, prioritise social housing and student housing. Allied with Barseghian after the first round to form a united left for the runoff.`, fr: `Candidat LFI. Programme d'extrême gauche : développer les services publics, s'opposer à l'austérité, prioriser le logement social et étudiant. Allié avec Barseghian après le premier tour pour former une union de la gauche au second.` },
      },
    ],
  },

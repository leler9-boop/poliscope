...
export const elections = [
  ...
  // ── fr_2027 ─────────────────────────────────────────────────────────────
  {
    ...
    year: 2027,
    description: {
      en: `France will elect a new president on 18 April 2027, with a second round on 2 May. Emmanuel Macron cannot stand again. LCP counted 16 officialised candidacies on 10 July 2026; Bernard Cazeneuve then presented his candidacy on 16 July. Poliscop separately labels declared candidates, party nominees, conditional candidacies, primary candidates, potential candidates and withdrawals instead of merging them into one misleading list.`,
      fr: `La France élira un nouveau président le 18 avril 2027, avec un second tour le 2 mai. Emmanuel Macron ne peut pas se représenter. LCP recensait 16 candidatures officialisées le 10 juillet 2026 ; Bernard Cazeneuve a ensuite présenté la sienne le 16 juillet. Poliscop distingue les candidats déclarés ou investis, les candidatures conditionnelles, les primaires, les personnes seulement pressenties et les retraits au lieu de les mélanger dans une liste trompeuse.`,
    },
    context: {
      en: [
        ...
        `With Macron unable to stand, the race is unusually open. Marine Le Pen declared her candidacy on 7 July 2026 after the appeal ruling; Jordan Bardella is therefore a contingency, not the current RN candidate. Édouard Philippe and Gabriel Attal are both declared, while Bruno Retailleau is LR's party nominee. Jean-Luc Mélenchon is declared and LFI is preparing the 2027 version of L'Avenir en commun. On the non-LFI left, the PS decision to hold a closed primary disrupted the planned unitary process: Marine Tondelier, François Ruffin, Clémentine Autain and Lydie Massard are consequently labelled conditional, while Raphaël Glucksmann remains potential. Fabien Roussel awaits the PCF members' vote scheduled for 6 September.\n\nStatuses and programme maturity were reviewed on 10 August 2026. Being included in an opinion poll never counts as a declaration. The current matching is an explicitly labelled Poliscop editorial estimate; individually sourced and reviewed positions remain the target for the verified version.`,
      ],
      fr: [
        ...
        `Macron ne pouvant se représenter, la course est inhabituellement ouverte. Marine Le Pen a déclaré sa candidature le 7 juillet 2026 après l'arrêt d'appel ; Jordan Bardella est donc un scénario de remplacement, pas le candidat actuel du RN. Édouard Philippe et Gabriel Attal sont déclarés, tandis que Bruno Retailleau est investi par LR. Jean-Luc Mélenchon est déclaré et LFI prépare la version 2027 de L'Avenir en commun. À gauche hors LFI, la décision du PS d'organiser une primaire fermée a bouleversé le processus unitaire prévu : Marine Tondelier, François Ruffin, Clémentine Autain et Lydie Massard sont donc classés comme conditionnels, tandis que Raphaël Glucksmann reste seulement pressenti. Fabien Roussel attend le vote des militants du PCF prévu le 6 septembre.\n\nLes statuts et la maturité des programmes ont été revus le 10 août 2026. Figurer dans un sondage ne vaut jamais déclaration. Le matching actuel est une estimation éditoriale Poliscop clairement signalée ; les positions sourcées et relues individuellement restent la cible de la future version vérifiée.`,
      ],
    },
    deeperContext: {
      en: [
        `The macroniste centre has weakened after two terms. Its two heirs — Attal (prime minister in 2024) and Philippe (prime minister 2017–2020) — are both declared. Polling institutes test several competing configurations rather than a settled ballot paper; recent surveys generally place Philippe ahead of Attal within the central bloc. On the left, the failure to agree on one selection process points to several competing candidacies, as in 2022.`,
      ...
      fr: [
        `Le centre macroniste s'est affaibli après deux mandats. Ses deux héritiers — Attal (Premier ministre en 2024) et Philippe (Premier ministre 2017–2020) — sont tous deux déclarés. Les instituts testent plusieurs configurations concurrentes plutôt qu'un bulletin de vote déjà stabilisé ; les enquêtes récentes placent généralement Philippe devant Attal au sein du bloc central. À droite, Marine Le Pen est la candidate actuelle du RN et Bardella son scénario de remplacement. À gauche, l'absence d'un processus unique laisse présager plusieurs candidatures concurrentes, comme en 2022.`,
    ...
    specificQuestions: [
      {
        ...
        positions: { lepen_2027: 4, philippe: 2, attal: 2, melenchon_2027: 5, glucksmann: 4, tondelier: 5, retailleau: 1, ruffin: 5, roussel_2027: 5, zemmour_2027: 1 },
      },
      {
        id: `fr_2027_q2`,
        ...
        positions: { lepen_2027: 5, philippe: 4, attal: 3, melenchon_2027: 1, glucksmann: 2, tondelier: 1, retailleau: 5, ruffin: 2, roussel_2027: 3, zemmour_2027: 5 },
      },
      {
        id: `fr_2027_q3`,
      ...
      },
      {
        ...
        positions: { lepen_2027: 3, philippe: 2, attal: 3, melenchon_2027: 5, glucksmann: 5, tondelier: 5, retailleau: 1, ruffin: 5, roussel_2027: 5, zemmour_2027: 2 },
      },
      {
        id: `fr_2027_q6`,
        ...
        positions: { lepen_2027: 1, philippe: 3, attal: 3, melenchon_2027: 4, glucksmann: 4, tondelier: 5, retailleau: 2, ruffin: 3, roussel_2027: 3, zemmour_2027: 1 },
      },
      {
        id: `fr_2027_q7`,
        ...
        positions: { lepen_2027: 5, philippe: 4, attal: 4, melenchon_2027: 1, glucksmann: 2, tondelier: 1, retailleau: 5, ruffin: 3, roussel_2027: 3, zemmour_2027: 5 },
      },
      {
        id: `fr_2027_q8`,
        ...
        positions: { lepen_2027: 3, philippe: 4, attal: 4, melenchon_2027: 1, glucksmann: 2, tondelier: 1, retailleau: 5, ruffin: 1, roussel_2027: 1, zemmour_2027: 4 },
      },
      {
        id: `fr_2027_q9`,
      ...
      },
      {
        ...
        positions: { lepen_2027: 5, philippe: 4, attal: 3, melenchon_2027: 3, glucksmann: 3, tondelier: 2, retailleau: 5, ruffin: 2, roussel_2027: 4, zemmour_2027: 5 },
      },
      {
        id: `fr_2027_q11`,
      ...
      },
      {
        ...
        positions: { lepen_2027: 3, philippe: 2, attal: 2, melenchon_2027: 5, glucksmann: 4, tondelier: 5, retailleau: 1, ruffin: 5, roussel_2027: 5, zemmour_2027: 1 },
      },
      {
        id: `fr_2027_q13`,
        ...
        positions: { lepen_2027: 3, philippe: 2, attal: 2, melenchon_2027: 5, glucksmann: 4, tondelier: 5, retailleau: 1, ruffin: 5, roussel_2027: 5, zemmour_2027: 2 },
      },
      {
        id: `fr_2027_q14`,
        ...
        positions: { lepen_2027: 1, philippe: 2, attal: 3, melenchon_2027: 4, glucksmann: 4, tondelier: 5, retailleau: 2, ruffin: 4, roussel_2027: 3, zemmour_2027: 1 },
      },
      {
        id: `fr_2027_q15`,
        ...
        positions: { lepen_2027: 4, philippe: 2, attal: 2, melenchon_2027: 5, glucksmann: 3, tondelier: 5, retailleau: 3, ruffin: 5, roussel_2027: 4, zemmour_2027: 3 },
      },
      {
        id: `fr_2027_q16`,
        ...
        positions: { lepen_2027: 5, philippe: 4, attal: 4, melenchon_2027: 2, glucksmann: 4, tondelier: 2, retailleau: 5, ruffin: 3, roussel_2027: 4, zemmour_2027: 5 },
      },
      {
        id: `fr_2027_q17`,
        ...
        positions: { lepen_2027: 4, philippe: 3, attal: 3, melenchon_2027: 5, glucksmann: 4, tondelier: 5, retailleau: 2, ruffin: 5, roussel_2027: 5, zemmour_2027: 3 },
      },
    ],
    candidates: [
      {
        ...
        result: { en: `Declared candidate (TF1, 7 Jul 2026) — eligible; cassation appeal announced (suspensive), Court of Cassation intends to rule before the first round; campaign launched 8 Jul with Bardella as prospective PM`, fr: `Candidate déclarée (TF1, 7 juil. 2026) — éligible ; pourvoi en cassation annoncé (suspensif), la Cour de cassation entend statuer avant le premier tour ; campagne lancée le 8 juil. avec Bardella annoncé comme Premier ministre` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 95, SECURITY: 88, ENVIRONMENT: 25, DEMOCRACY: 40, GLOBAL: 22, PUBLIC_SERVICES: 52 },
        description: { en: `Far-right nationalist, fourth presidential run. Her embezzlement conviction was upheld on appeal on 7 July 2026 with a reduced sentence and no immediate enforcement — her ineligibility was already served, so she is eligible. She declared her candidacy that evening on TF1, announced a cassation appeal (suspensive once filed), and the Court of Cassation has said it intends to rule before the first round. She launched her campaign with Jordan Bardella in La Flèche on 8 July 2026, presenting him as her prime minister in case of victory. Very anti-immigration, socially conservative, economically statist on purchasing power. Verified 2026-07-20 against national press consensus (franceinfo, France 24, LCP).`, fr: `Nationaliste d'extrême droite, quatrième candidature présidentielle. Sa condamnation pour détournement de fonds européens a été confirmée en appel le 7 juillet 2026 avec une peine réduite et sans exécution immédiate — son inéligibilité étant déjà purgée, elle est éligible. Elle a déclaré sa candidature le soir même sur TF1, annoncé un pourvoi en cassation (suspensif une fois déposé), et la Cour de cassation a indiqué vouloir statuer avant le premier tour. Elle a lancé sa campagne avec Jordan Bardella à La Flèche le 8 juillet 2026, le présentant comme son Premier ministre en cas de victoire. Très anti-immigration, conservatrice socialement, statiste sur le pouvoir d'achat. Vérifié le 2026-07-20 à partir d'un consensus de presse nationale (franceinfo, France 24, LCP).` },
      },
      {
        id: `philippe`,
        ...
        color: `#1a3d7c`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate since 3 Sept 2024 (Le Point interview); campaign launched 6 Jul 2026 ("Croire en nous"); polling at 20–26% in mid-2026`, fr: `Candidat déclaré depuis le 3 sept. 2024 (entretien au Point) ; campagne lancée le 6 juil. 2026 (« Croire en nous ») ; crédité de 20 à 26 % mi-2026` },
        profile: { ECONOMY: 68, SOCIAL: 52, IMMIGRATION: 55, SECURITY: 62, ENVIRONMENT: 55, DEMOCRACY: 78, GLOBAL: 72, PUBLIC_SERVICES: 45 },
        description: { en: `Centre-right liberal. Pro-EU, fiscally conservative, hardened stance on immigration (backed the 2024 immigration law), pragmatic reformer.`, fr: `Libéral de centre-droit. Pro-UE, conservateur sur les finances publiques, durci sur l'immigration (a soutenu la loi immigration 2024), réformiste pragmatique.` },
      },
      {
        id: `attal`,
        ...
        color: `#a08500`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate (22 May 2026, in Mur-de-Barrez, Aveyron)`, fr: `Candidat déclaré (22 mai 2026, à Mur-de-Barrez, Aveyron)` },
        profile: { ECONOMY: 63, SOCIAL: 62, IMMIGRATION: 50, SECURITY: 60, ENVIRONMENT: 58, DEMOCRACY: 80, GLOBAL: 75, PUBLIC_SERVICES: 48 },
        description: { en: `Centrist liberal. Macron's political heir, pro-EU, socially progressive but hardened on immigration as PM in 2024, economically liberal.`, fr: `Libéral centriste. Héritier politique de Macron, pro-UE, progressiste socialement mais durci sur l'immigration en tant que Premier ministre en 2024, libéral économiquement.` },
      },
      {
        id: `melenchon_2027`,
        image: `/images/candidates/melenchon.svg`,
        ...
        color: `#CC0000`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate (3 May 2026) — fourth presidential run; rejects any left primary`, fr: `Candidat déclaré (3 mai 2026) — quatrième candidature ; refuse toute primaire de la gauche` },
        profile: { ECONOMY: 12, SOCIAL: 88, IMMIGRATION: 12, SECURITY: 24, ENVIRONMENT: 82, DEMOCRACY: 58, GLOBAL: 30, PUBLIC_SERVICES: 90 },
        description: { en: `Radical left. Maximum welfare state, very pro-immigration, environmentalist, sovereignist left. Strong anti-NATO, opposed to arming Ukraine. Internal party democracy concerns noted.`, fr: `Gauche radicale. État social maximal, très pro-immigration, écologiste, souverainisme de gauche. Fermement anti-OTAN, opposé à l'armement de l'Ukraine. Fonctionnement interne du parti peu démocratique.` },
      },
      {
        id: `glucksmann`,
        ...
        result: { en: `NOT yet official — has given himself until early autumn 2026 to decide; possible route via the closed "socialist pole" primary (Oct 2026); leading moderate-left polling (10–16%)`, fr: `PAS encore officiel — s'est donné jusqu'au début de l'automne 2026 pour décider ; voie possible via la primaire fermée du « pôle socialiste » (oct. 2026) ; en tête de la gauche modérée dans les sondages (10-16 %)` },
        profile: { ECONOMY: 32, SOCIAL: 82, IMMIGRATION: 20, SECURITY: 38, ENVIRONMENT: 72, DEMOCRACY: 85, GLOBAL: 85, PUBLIC_SERVICES: 78 },
        description: { en: `Social democrat. Pro-EU, strong social protection, progressive, THE most prominent pro-Ukraine voice in French politics. Rejects radical redistribution.`, fr: `Social-démocrate. Pro-UE, forte protection sociale, progressiste, LA voix la plus engagée pour l'Ukraine en politique française. Refuse la redistribution radicale.` },
      },
      {
        id: `tondelier`,
        ...
        color: `#00A550`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate (22 Oct 2025), designated by Les Écologistes; running in the unified left primary of 11 Oct 2026`, fr: `Candidate déclarée (22 oct. 2025), désignée par Les Écologistes ; candidate à la primaire unitaire de la gauche du 11 oct. 2026` },
      ...
      },
      {
        ...
        color: `#0066CC`,
        candidacyStatus: `declared`,
        result: { en: `Official LR candidate — designated by the party on 19 April 2026`, fr: `Candidat officiel de LR — désigné par le parti le 19 avril 2026` },
        profile: { ECONOMY: 72, SOCIAL: 22, IMMIGRATION: 82, SECURITY: 90, ENVIRONMENT: 38, DEMOCRACY: 50, GLOBAL: 42, PUBLIC_SERVICES: 35 },
        description: { en: `Hard right conservative. Very tough on immigration and security (Interior Minister 2024), socially very conservative, questions some rule-of-law mechanisms, eurosceptic on migration and sovereignty.`, fr: `Droite dure conservatrice. Très ferme sur l'immigration et la sécurité (ministre de l'Intérieur 2024), très conservateur socialement, remet en cause certains mécanismes de l'état de droit, eurosceptique sur les migrations et la souveraineté.` },
      },
      {
        id: `ruffin`,
        image: `/images/candidates/ruffin.svg`,
        name: `François Ruffin`,
        party: { en: `Debout ! (left)`, fr: `Debout !` },
        color: `#c2431f`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate (1 April 2025); running in the unified left primary of 11 Oct 2026`, fr: `Candidat déclaré (1er avril 2025) ; candidat à la primaire unitaire de la gauche du 11 oct. 2026` },
        profile: { ECONOMY: 14, SOCIAL: 72, IMMIGRATION: 22, SECURITY: 34, ENVIRONMENT: 78, DEMOCRACY: 80, GLOBAL: 32, PUBLIC_SERVICES: 92 },
        description: { en: `Social left. MP for the Somme, filmmaker ("Merci patron !"), broke with LFI in 2024. Champions the working class of small-town France: higher wages, protectionism, strong public services, "popular ecology" that does not punish poorer households. More reserved than LFI on identity questions; critical of free-trade Europe.`, fr: `Gauche sociale. Député de la Somme, cinéaste (« Merci patron ! »), en rupture avec LFI depuis 2024. Défend la France des bourgs et des ouvriers : hausse des salaires, protectionnisme, services publics forts, « écologie populaire » qui ne pénalise pas les ménages modestes. Plus réservé que LFI sur les questions identitaires ; critique de l'Europe libre-échangiste.` },
      },
      {
        id: `roussel_2027`,
        image: `/images/candidates/roussel.svg`,
        ...
        color: `#cc0000`,
        candidacyStatus: `probable`,
        result: { en: `NOT yet official — "80% of the way there": PCF members vote on 6 Sept 2026; re-elected party leader with 70.1% at the Lille congress (5 July 2026)`, fr: `PAS encore officiel — « 80 % du chemin est fait » : vote des militants PCF le 6 sept. 2026 ; réélu à la tête du parti avec 70,1 % au congrès de Lille (5 juillet 2026)` },
        profile: { ECONOMY: 10, SOCIAL: 75, IMMIGRATION: 20, SECURITY: 42, ENVIRONMENT: 58, DEMOCRACY: 70, GLOBAL: 40, PUBLIC_SERVICES: 95 },
        description: { en: `Communist leader. Maximum public services, pro-worker economy, more measured on immigration than LFI (laïcité focus), less anti-nuclear than Greens. His candidacy is near-certain but not yet official: the PCF members' designation vote is set for 6 September 2026.`, fr: `Dirigeant communiste. Services publics maximaux, économie pro-travailleur, plus mesuré que LFI sur l'immigration (accent sur la laïcité), moins antinucléaire que les Verts. Sa candidature est quasi certaine mais pas encore officielle : le vote de désignation des militants PCF est fixé au 6 septembre 2026.` },
      },
      {
        id: `zemmour_2027`,
        image: `/images/candidates/zemmour.svg`,
        ...
        color: `#3a0000`,
        candidacyStatus: `probable`,
        result: { en: `NOT yet official — says he is "preparing" and will run: "If there is no primary, I will be a candidate. If there is one, I will enter the primary."`, fr: `PAS encore officiel — dit se « préparer » et affirme : « S'il n'y a pas de primaire, je serai candidat. S'il y en a une, je serai candidat à la primaire. »` },
        profile: { ECONOMY: 62, SOCIAL: 8, IMMIGRATION: 98, SECURITY: 92, ENVIRONMENT: 15, DEMOCRACY: 35, GLOBAL: 12, PUBLIC_SERVICES: 35 },
        description: { en: `Far-right nationalist, 2022 candidate (7.1% in the first round). Makes immigration and French identity the central issue ("remigration"), very tough on security and Islam, economically more liberal than the RN. His 2027 candidacy is near-certain per his own statements but has not been made official; he is open to a broad right-wing primary provided LR does not organise it.`, fr: `Nationaliste d'extrême droite, candidat en 2022 (7,1 % au premier tour). Fait de l'immigration et de l'identité française le sujet central (« remigration »), très dur sur la sécurité et l'islam, plus libéral économiquement que le RN. Sa candidature 2027 est quasi certaine selon ses propres déclarations mais n'a pas été officialisée ; il se dit ouvert à une primaire de la droite élargie à condition qu'elle ne soit pas organisée par LR.` },
      },
    ],
  },
    ...
    candidates: [
      {
        ...
        color: `#E75480`,
        result: { en: `Elected Mayor of Paris — won the run-off with over 50% (+9 points over Dati); led the first round with 37.98% (verified 2026-07-10, source: Mairie de Paris / ministère de l'Intérieur)`, fr: `Élu maire de Paris — vainqueur du second tour avec plus de 50 % (+9 points sur Dati) ; en tête au premier tour avec 37,98 % (vérifié le 2026-07-10, source : Mairie de Paris / ministère de l'Intérieur)` },
      ...
      },
      {
        ...
        party: { en: `Les Républicains`, fr: `Les Républicains` },
        color: `#0066CC`,
        result: { en: `Lost the run-off to Grégoire — placed second in the first round with 25.46% (verified 2026-07-10)`, fr: `Battue par Grégoire au second tour — deuxième au premier tour avec 25,46 % (vérifié le 2026-07-10)` },
      ...
      },
      {
        ...
        party: { en: `La France Insoumise`, fr: `La France Insoumise` },
        color: `#CC2200`,
        result: { en: `Third place — 11.72% in the first round, eliminated (verified 2026-07-10)`, fr: `Troisième place — 11,72 % au premier tour, éliminée (vérifié le 2026-07-10)` },
    ...
    specificQuestions: [
      {
        ...
        positions: { meloni: 5, letta_it: 1, salvini: 5, berlusconi: 4, conte: 3 },
      },
      {
        id: `it_2022_q2`,
        ...
        positions: { meloni: 4, letta_it: 1, salvini: 5, berlusconi: 4, conte: 3 },
      },
      {
        id: `it_2022_q3`,
        ...
        positions: { meloni: 1, letta_it: 4, salvini: 2, berlusconi: 2, conte: 5 },
      },
      {
        id: `it_2022_q4`,
        ...
        positions: { meloni: 3, letta_it: 5, salvini: 2, berlusconi: 4, conte: 3 },
      },
      {
        id: `it_2022_q5`,
        ...
        positions: { meloni: 2, letta_it: 4, salvini: 2, berlusconi: 3, conte: 4 },
      },
      {
        id: `it_2022_q6`,
        ...
        positions: { meloni: 5, letta_it: 2, salvini: 5, berlusconi: 4, conte: 3 },
      },
      {
        id: `it_2022_q7`,
        ...
        positions: { meloni: 1, letta_it: 5, salvini: 1, berlusconi: 2, conte: 3 },
      },
      {
        id: `it_2022_q8`,
        ...
        positions: { meloni: 3, letta_it: 4, salvini: 2, berlusconi: 2, conte: 5 },
      },
    ],
    candidates: [
      {
    ...
    specificQuestions: [
      {
        ...
        positions: { sanchez: 4, feijoo: 1, abascal: 1, diaz_es: 4 },
      },
      {
        id: `es_2023_q2`,
        ...
        positions: { sanchez: 2, feijoo: 4, abascal: 5, diaz_es: 1 },
      },
      {
        id: `es_2023_q3`,
        ...
        positions: { sanchez: 4, feijoo: 2, abascal: 3, diaz_es: 5 },
      },
      {
        id: `es_2023_q4`,
        ...
        positions: { sanchez: 5, feijoo: 1, abascal: 1, diaz_es: 4 },
      },
      {
        id: `es_2023_q5`,
        ...
        positions: { sanchez: 5, feijoo: 3, abascal: 1, diaz_es: 5 },
      },
      {
        id: `es_2023_q6`,
        ...
        positions: { sanchez: 4, feijoo: 2, abascal: 2, diaz_es: 5 },
      },
      {
        id: `es_2023_q7`,
        ...
        positions: { sanchez: 4, feijoo: 1, abascal: 2, diaz_es: 5 },
      },
      {
        id: `es_2023_q8`,
        ...
        positions: { sanchez: 1, feijoo: 3, abascal: 5, diaz_es: 1 },
      },
    ],
    candidates: [
      {

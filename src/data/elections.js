...
export const elections = [
  ...
  // ── paris_2026 ───────────────────────────────────────────────────────────
  {
    ...
    deeperContext: {
      en: [
        `Paris politics mirror national divides but with local twists. The city leans left: it has not had a right-wing mayor since 1995. But Hidalgo's approval ratings have been weakened by the homeless crisis, perceived mismanagement during the 2024 Olympics, and rising rents.`,
        `Key debates:\n• Car-free zones and cycling lanes — Paris has removed tens of thousands of parking spaces\n• The Seine-Saint-Denis gap — inequality between Paris and its northern suburbs\n• Tourism vs. liveability — 40 million visitors per year strains infrastructure\n• Public cleanliness — surveys consistently rank it as Parisians' top complaint\n• Housing — Paris is one of Europe's most expensive rental markets`,
      ],
      fr: [
        `La politique parisienne reflète les clivages nationaux avec des nuances locales. La ville penche à gauche : elle n'a pas eu de maire de droite depuis 1995. Mais la cote de popularité d'Hidalgo a souffert de la crise des sans-abri, de la gestion des JO 2024 et de la hausse des loyers.`,
        `Débats clés :\n• Zones sans voiture et pistes cyclables\n• Le fossé avec la Seine-Saint-Denis\n• Tourisme vs qualité de vie — 40 millions de visiteurs par an\n• Propreté — première préoccupation des Parisiens\n• Logement — l'un des marchés locatifs les plus chers d'Europe`,
      ],
    },
    specificQuestions: [
      {
        ...
        theme: `ENVIRONMENT`, direction: 1,
        info: { en: `Hidalgo has created extensive cycling lanes and removed parking spaces. Critics say it harms businesses and disadvantages residents without cars.`, fr: `Hidalgo a créé de nombreuses pistes cyclables et supprimé des places de stationnement. Les critiques estiment que cela nuit aux commerces et pénalise les résidents sans voiture.` },
        positions: { hidalgo: 5, dati: 1, belliard: 5, beaune: 3 },
      },
      {
        id: `paris_2026_q2`,
        text: { en: `The city should prioritise building new social housing to address the housing crisis.`, fr: `La ville devrait prioriser la construction de nouveaux logements sociaux pour répondre à la crise du logement.` },
        theme: `PUBLIC_SERVICES`, direction: 1,
        info: { en: `Paris has one of Europe's tightest housing markets. Social housing waitlists stretch to 10 years. The debate is between building more versus incentivising private construction.`, fr: `Paris a l'un des marchés immobiliers les plus tendus d'Europe. Les listes d'attente de logements sociaux atteignent 10 ans. Le débat oppose la construction publique à l'incitation privée.` },
        positions: { hidalgo: 4, dati: 2, belliard: 5, beaune: 3 },
      },
      {
        id: `paris_2026_q3`,
        text: { en: `Paris should invest more in cleaning and maintaining public spaces.`, fr: `Paris devrait investir davantage dans le nettoyage et l'entretien des espaces publics.` },
        theme: `PUBLIC_SERVICES`, direction: 1,
        info: { en: `Cleanliness is persistently ranked as Paris residents' top complaint. All major candidates have promised increased cleaning budgets.`, fr: `La propreté est systématiquement citée comme la première préoccupation des Parisiens. Tous les grands candidats ont promis d'augmenter le budget de nettoyage.` },
        positions: { hidalgo: 3, dati: 5, belliard: 4, beaune: 4 },
      },
      {
        id: `paris_2026_q4`,
        text: { en: `Paris should expand its cycle lane network across the whole city.`, fr: `Paris devrait étendre son réseau de pistes cyclables à l'ensemble de la ville.` },
        theme: `ENVIRONMENT`, direction: 1,
        info: { en: `Hidalgo has positioned Paris as a cycling city. The cycle lane network is now among the densest in Europe but remains controversial in outer arrondissements.`, fr: `Hidalgo a positionné Paris comme une ville cyclable. Le réseau de pistes cyclables est parmi les plus denses d'Europe mais reste controversé dans les arrondissements périphériques.` },
        positions: { hidalgo: 5, dati: 1, belliard: 5, beaune: 3 },
      },
      {
        id: `paris_2026_q5`,
        text: { en: `The city should do more to support small businesses and local shops.`, fr: `La ville devrait faire davantage pour soutenir les petits commerces et les boutiques locales.` },
        theme: `ECONOMY`, direction: -1,
        info: { en: `Small businesses have struggled with rent increases, reduced car access, and construction disruption. Both left and right agree on supporting local commerce but disagree on how.`, fr: `Les petits commerces ont souffert de la hausse des loyers, de la réduction de l'accès en voiture et des perturbations de chantier. Gauche et droite s'accordent sur le soutien au commerce local mais divergent sur les moyens.` },
        positions: { hidalgo: 3, dati: 5, belliard: 3, beaune: 4 },
      },
      {
        id: `paris_2026_q6`,
        text: { en: `Paris should set stricter regulations on tourist rentals like Airbnb.`, fr: `Paris devrait imposer des réglementations plus strictes sur les locations touristiques comme Airbnb.` },
        theme: `SOCIAL`, direction: 1,
        info: { en: `Paris has tens of thousands of short-term rental listings, reducing housing availability for residents. The city has tightened rules but enforcement remains limited.`, fr: `Paris compte des dizaines de milliers d'annonces de location courte durée, réduisant l'offre de logements. La ville a renforcé les règles mais l'application reste limitée.` },
        positions: { hidalgo: 4, dati: 2, belliard: 5, beaune: 3 },
      },
      {
        id: `paris_2026_q7`,
        text: { en: `Security and police presence in Paris should be significantly strengthened.`, fr: `La sécurité et la présence policière à Paris devraient être significativement renforcées.` },
        theme: `SECURITY`, direction: 1,
        info: { en: `Drug markets in parks and public disorder are concerns for Parisians. The right advocates more police; the left argues for social investment alongside enforcement.`, fr: `Les marchés de drogue dans les parcs et le désordre public préoccupent les Parisiens. La droite prône plus de police ; la gauche préconise l'investissement social en parallèle.` },
        positions: { hidalgo: 2, dati: 5, belliard: 2, beaune: 3 },
      },
      {
        id: `paris_2026_q8`,
        text: { en: `Paris should become carbon neutral by 2030.`, fr: `Paris devrait atteindre la neutralité carbone d'ici 2030.` },
        theme: `ENVIRONMENT`, direction: 1,
        info: { en: `Paris has committed to climate neutrality. The Greens want faster action; the right argues the timelines are unrealistic and too costly.`, fr: `Paris s'est engagée à la neutralité climatique. Les Verts veulent accélérer ; la droite estime que les calendriers sont irréalistes et trop coûteux.` },
        positions: { hidalgo: 4, dati: 1, belliard: 5, beaune: 3 },
      },
    ],
    candidates: [
      {
        ...
        party: { en: `Parti Socialiste`, fr: `Parti Socialiste` },
        color: `#E75480`,
        result: { en: `Incumbent mayor (seeking 3rd term)`, fr: `Maire sortante (3e mandat)` },
        profile: { ECONOMY: 25, SOCIAL: 88, IMMIGRATION: 18, SECURITY: 35, ENVIRONMENT: 75, DEMOCRACY: 82, GLOBAL: 20, PUBLIC_SERVICES: 84 },
        description: { en: `Socialist. Pro-cycling, climate-focused, strong public services, pro-immigration.`, fr: `Socialiste. Pro-vélo, axée sur le climat, services publics forts, pro-immigration.` },
      },
      {
        id: `dati`,
        ...
        party: { en: `Les Républicains`, fr: `Les Républicains` },
        color: `#0066CC`,
        result: { en: `Main opposition candidate`, fr: `Principale candidate d'opposition` },
        profile: { ECONOMY: 65, SOCIAL: 40, IMMIGRATION: 62, SECURITY: 75, ENVIRONMENT: 45, DEMOCRACY: 72, GLOBAL: 38, PUBLIC_SERVICES: 42 },
        description: { en: `Conservative. Security-focused, pro-business, critical of car restrictions, law and order.`, fr: `Conservatrice. Axée sur la sécurité, pro-business, critique des restrictions voiture, ordre public.` },
      },
      {
        id: `belliard`,
        image: `/images/candidates/belliard.svg`,
        name: `David Belliard`,
        party: { en: `Les Écologistes`, fr: `Les Écologistes` },
        color: `#00A550`,
        result: { en: `Green candidate`, fr: `Candidat écologiste` },
        profile: { ECONOMY: 22, SOCIAL: 85, IMMIGRATION: 18, SECURITY: 28, ENVIRONMENT: 94, DEMOCRACY: 85, GLOBAL: 20, PUBLIC_SERVICES: 72 },
        description: { en: `Green ecologist. Radical climate action, car-free city, anti-gentrification, social housing.`, fr: `Écologiste vert. Action climatique radicale, ville sans voiture, anti-gentrification, logement social.` },
      },
      {
        id: `beaune`,
        image: `/images/candidates/beaune.svg`,
        name: `Clément Beaune`,
        party: { en: `Renaissance`, fr: `Renaissance` },
        color: `#FFD700`,

...
const TOPICS = [
  ...
  },
  {
    id: 'logement',
    icon: '🏠',
    title: { en: `Housing`, fr: `Le logement` },
    definition: {
      en: `Housing is one of the most pressing issues for young people in France today. Rents have surged in big cities, social housing waiting lists stretch for years, and home ownership is increasingly out of reach for many. The political debate: should the state regulate the market, build more, or subsidise demand?`,
      fr: `Le logement est l'une des questions les plus urgentes pour les jeunes en France aujourd'hui. Les loyers ont explosé dans les grandes villes, les listes d'attente pour les HLM s'allongent depuis des années, et devenir propriétaire devient hors de portée pour beaucoup. Le débat politique : l'État doit-il réguler le marché, construire davantage, ou subventionner la demande ?`,
    },
    example: {
      en: `In Paris, a 25 m² studio can cost €1,000/month. A young person earning the minimum wage (around €1,400 net) would spend 70% of their income on rent. The Abbé Pierre Foundation estimates 4 million people in France are badly housed or homeless.`,
      fr: `À Paris, un studio de 25 m² peut coûter 1 000 €/mois. Un jeune au SMIC (environ 1 400 € nets) y consacrerait 70% de ses revenus. La Fondation Abbé Pierre estime que 4 millions de personnes en France sont mal logées ou sans domicile.`,
    },
    extended: {
      en: `Housing is political because the state has shaped the market for decades — through rent controls, social housing (HLM), tax breaks for landlords, and zoning rules. Every choice creates winners and losers.\n\nThe French HLM system houses about 10 million people. But demand far exceeds supply in cities: waiting lists can stretch 5–10 years in Paris. Some argue the solution is to build massively — more social housing, more dense urban development. Others argue deregulation would lower prices by increasing private supply.\n\nRent controls are divisive. Supporters say they protect tenants from exploitation, especially in cities where housing is a necessity not a luxury. Critics say they discourage landlords from renting out properties, reduce supply, and ultimately make the shortage worse.\n\nFor young people specifically, the "SRU law" requires 20–25% of homes in larger communes to be social housing — but enforcement is patchy. The "Pinel" tax relief scheme incentivised private landlords to build rentals, but critics said it drove up prices in already-expensive areas.\n\nMost parties agree there's a housing crisis. The disagreement is about causes and solutions: regulate the market, subsidise construction, penalise empty homes, or reform land use rules.`,
      fr: `Le logement est politique parce que l'État a façonné le marché depuis des décennies — par les encadrements de loyers, les HLM, les avantages fiscaux pour les propriétaires, et les règles d'urbanisme. Chaque choix crée des gagnants et des perdants.\n\nLe système HLM français loge environ 10 millions de personnes. Mais la demande dépasse largement l'offre dans les villes : les listes d'attente peuvent s'étirer sur 5 à 10 ans à Paris. Certains soutiennent que la solution est de construire massivement — plus de logements sociaux, plus de densification urbaine. D'autres estiment que la déréglementation ferait baisser les prix en augmentant l'offre privée.\n\nL'encadrement des loyers divise. Ses partisans disent qu'il protège les locataires contre l'exploitation, surtout dans les villes où le logement est une nécessité, pas un luxe. Ses critiques affirment qu'il décourage les propriétaires de louer leurs biens, réduit l'offre, et aggrave finalement la pénurie.\n\nPour les jeunes en particulier, la loi SRU impose 20 à 25 % de logements sociaux dans les communes importantes — mais son application est inégale. Le dispositif Pinel incitait les propriétaires privés à construire des locations, mais ses critiques disent qu'il a fait monter les prix dans des zones déjà chères.\n\nLa plupart des partis s'accordent sur l'existence d'une crise du logement. Le désaccord porte sur les causes et les solutions : réguler le marché, subventionner la construction, pénaliser les logements vacants, ou réformer les règles d'urbanisme.`,
    },
  },
  {
    id: 'union_europeenne',
    icon: '🇪🇺',
    title: { en: `The European Union`, fr: `L'Union européenne` },
    definition: {
      en: `The EU is a political and economic union of 27 countries that share some common rules, a single market, and (for most members) a single currency. France was one of its founders. The debate: is European integration a force for strength and peace, or a bureaucratic project that erodes national democracy?`,
      fr: `L'UE est une union politique et économique de 27 pays qui partagent certaines règles communes, un marché unique, et (pour la plupart) une monnaie unique. La France en est l'un des fondateurs. Le débat : l'intégration européenne est-elle une force de puissance et de paix, ou un projet bureaucratique qui érode la démocratie nationale ?`,
    },
    example: {
      en: `Because of the EU, a French person can work in Germany without a visa, buy Spanish tomatoes without customs duties, and rely on consumer protections that apply from Lisbon to Warsaw. But French fishing quotas are negotiated in Brussels, and the EU's stability rules limit how much the French government can borrow.`,
      fr: `Grâce à l'UE, un Français peut travailler en Allemagne sans visa, acheter des tomates espagnoles sans droits de douane, et bénéficier de protections pour les consommateurs qui s'appliquent de Lisbonne à Varsovie. Mais les quotas de pêche français sont négociés à Bruxelles, et les règles de stabilité européennes limitent les emprunts du gouvernement français.`,
    },
    extended: {
      en: `The EU started as a peace project after World War II: the idea was that countries that trade together don't go to war. It evolved from a coal-and-steel community into a vast political and legal structure.\n\nProponents argue the EU gives European countries collective power they couldn't have alone. France's voice in trade negotiations with China or the US is far stronger as part of a 450-million-person bloc. The single market has brought prosperity. EU institutions have protected democracy in countries like Hungary and Poland (with mixed results).\n\nSceptics argue the EU has accumulated too much power. Decisions are made by unelected commissioners or in complex Council negotiations, far from democratic accountability. The euro, they say, has been particularly damaging for weaker economies like Greece or Italy, which can no longer devalue their currency in a crisis.\n\nIn French politics, attitudes to Europe cut across traditional left–right lines. The "souverainiste" tradition (strong at both extremes) argues for repatriating powers to France. Pro-European positions dominate the centre. The debate has intensified since Brexit, the COVID pandemic (which showed both EU coordination and its limits), and the Ukraine war (which reinforced the case for European solidarity).`,
      fr: `L'UE a commencé comme un projet de paix après la Seconde Guerre mondiale : l'idée était que les pays qui commercent ensemble ne se font pas la guerre. Elle a évolué d'une communauté du charbon et de l'acier en une vaste structure politique et juridique.\n\nSes partisans soutiennent que l'UE donne aux pays européens une puissance collective qu'ils n'auraient pas seuls. La voix de la France dans les négociations commerciales avec la Chine ou les États-Unis est bien plus forte au sein d'un bloc de 450 millions de personnes. Le marché unique a apporté la prospérité. Les institutions européennes ont protégé la démocratie dans des pays comme la Hongrie et la Pologne (avec des résultats mitigés).\n\nLes sceptiques soutiennent que l'UE a accumulé trop de pouvoir. Les décisions sont prises par des commissaires non élus ou lors de négociations complexes au Conseil, loin de toute responsabilité démocratique. L'euro, disent-ils, a été particulièrement néfaste pour les économies plus faibles comme la Grèce ou l'Italie, qui ne peuvent plus dévaluer leur monnaie en temps de crise.\n\nDans la politique française, les attitudes vis-à-vis de l'Europe traversent les clivages gauche-droite traditionnels. La tradition « souverainiste » (forte aux deux extrêmes) plaide pour rapatrier les pouvoirs vers la France. Les positions pro-européennes dominent au centre. Le débat s'est intensifié depuis le Brexit, la pandémie de COVID (qui a montré à la fois la coordination européenne et ses limites), et la guerre en Ukraine (qui a renforcé l'argument de la solidarité européenne).`,
    },
  },
  {
    id: 'otan',
    icon: '🛡️',
    title: { en: `NATO and Defence`, fr: `L'OTAN et la défense` },
    definition: {
      en: `NATO is a military alliance of 32 countries (including France and the US) that agree to defend each other if one is attacked. The debate: should Europe rely on the US for its security, or build its own defence? And what role should France play?`,
      fr: `L'OTAN est une alliance militaire de 32 pays (dont la France et les États-Unis) qui s'engagent à se défendre mutuellement si l'un d'eux est attaqué. Le débat : l'Europe doit-elle compter sur les États-Unis pour sa sécurité, ou construire sa propre défense ? Et quel rôle la France doit-elle jouer ?`,
    },
    example: {
      en: `When Russia invaded Ukraine in 2022, NATO countries sent weapons, money, and intelligence to Ukraine. France sent Caesar artillery systems and trained Ukrainian soldiers. The war brought NATO back to the centre of European politics — and raised questions about whether France should spend more on defence.`,
      fr: `Quand la Russie a envahi l'Ukraine en 2022, les pays de l'OTAN ont envoyé des armes, de l'argent et du renseignement à l'Ukraine. La France a envoyé des systèmes d'artillerie Caesar et formé des soldats ukrainiens. La guerre a replacé l'OTAN au centre de la politique européenne — et soulevé des questions sur le niveau de dépenses militaires de la France.`,
    },
    extended: {
      en: `France has a complicated relationship with NATO. In 1966, de Gaulle withdrew France from NATO's integrated military command, arguing it compromised French sovereignty. France only fully rejoined in 2009 under Sarkozy. This history still shapes French debates about autonomy vs. alliance.\n\nProponents of strong NATO commitment argue that European security depends on the US nuclear umbrella and military capacity. Russia's 2022 invasion of Ukraine showed that military threats in Europe are real. Article 5 — the mutual defence clause — only works if allies trust each other's commitment.\n\nSceptics — from both left and right — argue that NATO entangles France in US foreign policy interests, risks provoking adversaries, and undermines European strategic autonomy. Some on the left oppose NATO on principle, as an instrument of US imperialism. Some on the right want France to maintain a fully independent foreign policy.\n\nThe Ukraine war has shifted the centre of gravity. Most mainstream parties now accept that European defence needs to be strengthened. The debate is about how much to spend (France currently spends about 2% of GDP on defence), whether to send troops to Ukraine, and how to build a genuine European defence capability alongside NATO.`,
      fr: `La France entretient une relation compliquée avec l'OTAN. En 1966, de Gaulle a retiré la France du commandement militaire intégré de l'OTAN, estimant que cela compromettait la souveraineté française. La France n'a pleinement réintégré l'OTAN qu'en 2009 sous Sarkozy. Cette histoire continue de façonner les débats français sur l'autonomie vs l'alliance.\n\nLes partisans d'un fort engagement dans l'OTAN soutiennent que la sécurité européenne dépend du parapluie nucléaire américain et de sa capacité militaire. L'invasion russe de l'Ukraine en 2022 a montré que les menaces militaires en Europe sont réelles. L'article 5 — la clause de défense mutuelle — ne fonctionne que si les alliés se font confiance.\n\nLes sceptiques — de gauche comme de droite — soutiennent que l'OTAN entraîne la France dans les intérêts de politique étrangère américains, risque de provoquer des adversaires, et compromet l'autonomie stratégique européenne. Certains à gauche s'opposent à l'OTAN par principe, comme instrument de l'impérialisme américain. Certains à droite veulent que la France maintienne une politique étrangère totalement indépendante.\n\nLa guerre en Ukraine a déplacé le centre de gravité. La plupart des partis du courant dominant acceptent désormais que la défense européenne doit être renforcée. Le débat porte sur les dépenses (la France consacre actuellement environ 2 % de son PIB à la défense), l'envoi de troupes en Ukraine, et la façon de construire une véritable capacité de défense européenne aux côtés de l'OTAN.`,
    },
  },
  {
    id: 'globalization',

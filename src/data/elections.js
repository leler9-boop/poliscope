    ...
    candidates: [
      {
        ...
        description: { en: `Far-right nationalist. Very anti-immigration, socially conservative, economically statist on purchasing power. Candidate pending outcome of her trial for embezzlement of EU funds (verdict expected 2025–2026).`, fr: `Nationaliste d'extrême droite. Très anti-immigration, conservatrice socialement, statiste sur le pouvoir d'achat. Candidature conditionnelle à l'issue de son procès pour détournement de fonds européens (verdict attendu 2025–2026).` },
      },
      {
        id: `philippe`,
      ...
      {
        id: `bardella`,
        variantOf: `lepen_2027`,
        image: `/images/candidates/bardella.svg`,
        name: `Jordan Bardella`,
        party: { en: `Rassemblement National`, fr: `Rassemblement National` },
        color: `#003189`,
        result: { en: `RN fallback candidate if Le Pen is ineligible`, fr: `Candidat de substitution du RN si Le Pen est inéligible` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 96, SECURITY: 88, ENVIRONMENT: 22, DEMOCRACY: 38, GLOBAL: 14, PUBLIC_SERVICES: 58 },
        description: { en: `RN president. Would be the RN presidential candidate if Le Pen is barred. More radical than Le Pen on immigration and sovereignty; dropped Frexit but remains the most eurosceptic major candidate.`, fr: `Président du RN. Serait le candidat RN si Le Pen est inéligible. Plus radical que Le Pen sur l'immigration et la souveraineté ; a abandonné le Frexit mais reste le candidat major le plus eurosceptique.` },
      },
      {
        id: `castets`,
        ...
        color: `#b22222`,
        result: { en: `NFP unity candidate (projected)`, fr: `Candidate d'union du NFP (pressentie)` },
      ...
      },
      {
        ...
        party: { en: `Parti Communiste Français`, fr: `Parti Communiste Français` },
        color: `#cc0000`,
        result: { en: `PCF candidate (projected)`, fr: `Candidat PCF (pressenti)` },

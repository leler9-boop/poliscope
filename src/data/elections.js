...
export const elections = [
  ...
  // ── fr_2027 ─────────────────────────────────────────────────────────────
  {
    ...
    year: 2027,
    description: {
      en: `France will elect a new president in spring 2027. Emmanuel Macron cannot stand again. Marine Le Pen's conviction was upheld on appeal in July 2026, but her ineligibility has since expired and she has declared her candidacy; Jordan Bardella remains RN president. Jean-Luc Mélenchon has also declared his candidacy.`,
      fr: `La France élira un nouveau président au printemps 2027. Emmanuel Macron ne peut pas se représenter. La condamnation de Marine Le Pen a été confirmée en appel en juillet 2026, mais sa peine d'inéligibilité a depuis expiré et elle a déclaré sa candidature ; Jordan Bardella reste président du RN. Jean-Luc Mélenchon a également déclaré sa candidature.`,
    },
    context: {
      en: [
        ...
        `With Macron unable to stand, the race is unusually open. Marine Le Pen's embezzlement conviction was upheld by the Paris Court of Appeal on 7 July 2026, but her sentence was reduced: 3 years in prison (1 year under electronic monitoring), a €100,000 fine, and 45 months of ineligibility (30 of them suspended) — the 15-month firm portion, running from the March 2025 provisional enforcement, had already been served by 30 June 2026, and the appellate court did not order immediate enforcement of the new sentence either. She declared her candidacy on TF1 that same evening ("I am a candidate ... and I will not change my mind") and has announced she will file a cassation appeal, which she has ten days to formally lodge (i.e. by roughly 17 July 2026) — no source confirms the appeal has actually been filed yet. A filed cassation appeal is automatically suspensive under French criminal procedure. Jordan Bardella remains RN president; the two have campaigned jointly, with reporting describing him as her prospective prime minister rather than a rival candidate. Jean-Luc Mélenchon officially declared his fourth presidential run in late May 2026. A left-wing primary is scheduled for October 11, 2026, though both Mélenchon and Glucksmann have refused to participate.\n\n⚠ Candidacy statuses verified 2026-07-11 against convergent national press (Touteleurope, franceinfo, France 24, Le Club des Juristes) — no primary judicial source consulted for the appeal ruling's exact terms; confidence: high on the candidacy declaration and eligibility, medium on the cassation filing status (announced, not confirmed filed) and on Bardella's exact role (no formal RN investiture process documented). "Probable" = publicly positioning but not officially declared. "Speculative" = plausible but unconfirmed.`,
      ],
      fr: [
        ...
        `Macron ne pouvant se représenter, la course est inhabituellement ouverte. La condamnation de Marine Le Pen pour détournement de fonds européens a été confirmée en appel le 7 juillet 2026, mais sa peine d'inéligibilité (réduite à 15 mois fermes) était déjà purgée au 30 juin 2026, et la cour d'appel n'a pas assorti la nouvelle peine d'une exécution provisoire : elle est donc éligible. Le soir même, elle a déclaré sa candidature sur TF1 (« Je suis candidate ... et je ne changerai pas d'avis ») et a annoncé son intention de former un pourvoi en cassation — un délai légal de dix jours lui est ouvert pour le faire (soit jusqu'à environ le 17 juillet 2026) ; aucune source ne confirme à ce stade que le pourvoi a été effectivement déposé. Une fois déposé, un pourvoi en cassation est automatiquement suspensif en droit pénal français. Jordan Bardella reste président du RN ; les deux ont fait campagne ensemble, la presse le décrivant comme son futur Premier ministre plutôt que comme un candidat concurrent. Jean-Luc Mélenchon a officiellement déclaré sa candidature fin mai 2026 ; Édouard Philippe (Horizons) et Gabriel Attal (Renaissance) se positionnent sans candidature officielle, de même que Raphaël Glucksmann et Marine Tondelier à gauche.\n\n⚠ Statuts de candidature vérifiés le 2026-07-11 à partir de la presse nationale convergente (Touteleurope, franceinfo, France 24, Le Club des Juristes) — aucune source judiciaire primaire consultée pour le détail exact du verdict d'appel ; confiance : haute sur la déclaration de candidature et l'éligibilité, moyenne sur le statut du pourvoi (annoncé, non confirmé déposé) et sur le rôle exact de Bardella (aucun processus d'investiture formelle du RN documenté).`,
      ],
    },
    deeperContext: {
      en: [
      ...
      fr: [
        `Le centre macroniste s'est affaibli après deux mandats. Ses deux héritiers — Attal (Premier ministre en 2024) et Philippe (Premier ministre 2017–2020) — risquent de diviser le vote centriste. À droite, Marine Le Pen reste la figure dominante du RN malgré sa condamnation, Bardella conservant la présidence du parti. La gauche cherche à se rassembler autour d'une candidature commune lors d'une primaire le 11 octobre 2026.`,
    ...
    candidates: [
      {
        ...
        result: { en: `Eligible and declared candidate (TF1, 7 Jul 2026) — conviction upheld on appeal, ineligibility already served; cassation appeal announced, not confirmed filed (10-day deadline, ~17 Jul 2026)`, fr: `Éligible et candidate déclarée (TF1, 7 juil. 2026) — condamnation confirmée en appel, inéligibilité déjà purgée ; pourvoi en cassation annoncé, non confirmé déposé (délai de 10 jours, ~17 juil. 2026)` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 95, SECURITY: 88, ENVIRONMENT: 25, DEMOCRACY: 40, GLOBAL: 22, PUBLIC_SERVICES: 52 },
        description: { en: `Far-right nationalist. Convicted of embezzling EU funds; the Paris Court of Appeal upheld the conviction on 7 July 2026 but reduced the sentence to 3 years in prison (1 firm, under electronic monitoring), a €100,000 fine, and 45 months of ineligibility (30 suspended) — the 15-month firm portion was already served by 30 June 2026, and the appellate court ordered no immediate enforcement of the new sentence. She declared her candidacy that evening on TF1 and has announced she will file a cassation appeal (not confirmed filed as of verification date; 10-day legal deadline). Very anti-immigration, socially conservative, economically statist on purchasing power. Verified 2026-07-11 against national press consensus (Touteleurope, franceinfo, France 24, Le Club des Juristes) — no primary judicial source consulted for the ruling's exact terms.`, fr: `Nationaliste d'extrême droite. Condamnée pour détournement de fonds européens ; la cour d'appel de Paris a confirmé la condamnation le 7 juillet 2026 mais a réduit la peine à 3 ans de prison (1 an ferme sous bracelet électronique), 100 000 € d'amende et 45 mois d'inéligibilité (30 avec sursis) — les 15 mois fermes restants étaient déjà purgés au 30 juin 2026, et la cour d'appel n'a pas ordonné l'exécution immédiate de la nouvelle peine. Elle a déclaré sa candidature le soir même sur TF1 et a annoncé son intention de former un pourvoi en cassation (non confirmé déposé à la date de vérification ; délai légal de 10 jours). Très anti-immigration, conservatrice socialement, statiste sur le pouvoir d'achat. Vérifié le 2026-07-11 à partir d'un consensus de presse nationale (Touteleurope, franceinfo, France 24, Le Club des Juristes) — aucune source judiciaire primaire consultée pour le détail exact du verdict.` },
      },
      {
        id: `philippe`,
        ...
        result: { en: `Probable candidate — not officially declared`, fr: `Candidat probable — non officiellement déclaré` },
      ...
      },
      {
        ...
        color: `#a08500`,
        candidacyStatus: `speculative`,
        result: { en: `Speculative — positioning but not declared`, fr: `Spéculatif — en positionnement, non déclaré` },
      ...
      },
      {
        ...
        color: `#CC0000`,
        candidacyStatus: `declared`,
        result: { en: `Declared candidate (May 2026)`, fr: `Candidat déclaré (mai 2026)` },
      ...
      },
      {
        ...
        color: `#00A550`,
        candidacyStatus: `speculative`,
        result: { en: `Speculative — may enter left primary (Oct 2026)`, fr: `Spéculative — pourrait participer à la primaire de gauche (oct. 2026)` },
      ...
      {
        id: `bardella`,
        image: `/images/candidates/bardella.svg`,
        name: `Jordan Bardella`,
        party: { en: `Rassemblement National`, fr: `Rassemblement National` },
        color: `#003189`,
        candidacyStatus: `speculative`,
        result: { en: `RN president — not currently the presidential candidate; campaigning alongside Le Pen, described in press reporting as her prospective PM (not an official RN investiture)`, fr: `Président du RN — n'est actuellement pas le candidat à la présidentielle ; fait campagne aux côtés de Le Pen, présenté par la presse comme son futur Premier ministre (pas une investiture officielle du RN)` },
        profile: { ECONOMY: 40, SOCIAL: 12, IMMIGRATION: 96, SECURITY: 88, ENVIRONMENT: 22, DEMOCRACY: 38, GLOBAL: 14, PUBLIC_SERVICES: 58 },
        description: { en: `RN president. More radical than Le Pen on immigration and sovereignty; dropped Frexit but remains the most eurosceptic major candidate. Was the RN's likely standard-bearer while Le Pen's ineligibility stood; since her conviction was upheld with a reduced, already-served sentence and no immediate enforcement (appeal ruling, 7 July 2026), Le Pen has declared her own candidacy and the two have campaigned jointly — press reporting describes Bardella as her prospective prime minister rather than a rival candidate, though no formal RN investiture process for either has been documented. Verified 2026-07-11.`, fr: `Président du RN. Plus radical que Le Pen sur l'immigration et la souveraineté ; a abandonné le Frexit mais reste le candidat majeur le plus eurosceptique. Il était le candidat naturel tant que l'inéligibilité de Le Pen tenait ; sa condamnation ayant été confirmée en appel avec une peine réduite, déjà purgée et sans exécution immédiate (verdict du 7 juillet 2026), Le Pen a déclaré sa propre candidature et les deux ont fait campagne ensemble — la presse présente Bardella comme son futur Premier ministre plutôt que comme un candidat concurrent, sans qu'aucun processus d'investiture formelle du RN n'ait été documenté pour l'un ou l'autre. Vérifié le 2026-07-11.` },
      },
      {
        id: `castets`,
        image: `/images/candidates/castets.svg`,
        name: `Lucie Castets`,
        party: { en: `Nouveau Front Populaire (NFP)`, fr: `Nouveau Front Populaire (NFP)` },
        color: `#b22222`,
        candidacyStatus: `probable`,
        result: { en: `Probable — depends on left primary (Oct 11, 2026)`, fr: `Probable — dépend de la primaire de gauche (11 oct. 2026)` },
        profile: { ECONOMY: 18, SOCIAL: 84, IMMIGRATION: 10, SECURITY: 28, ENVIRONMENT: 80, DEMOCRACY: 85, GLOBAL: 70, PUBLIC_SERVICES: 92 },
        description: { en: `NFP unity candidate. Senior civil servant turned left coalition figurehead. Anti-austerity, pro-immigration, strong climate commitments, pro-EU but critical of market integration.`, fr: `Candidate d'union du NFP. Haute fonctionnaire devenue figure de la coalition de gauche. Anti-austérité, pro-immigration, engagements climatiques forts, pro-UE mais critique de l'intégration marchande.` },
      },
      {
        id: `roussel_2027`,
        image: `/images/candidates/roussel.svg`,
        ...
        color: `#cc0000`,
        candidacyStatus: `probable`,
        result: { en: `Probable — may run outside left primary`, fr: `Probable — pourrait se présenter hors primaire de gauche` },
        profile: { ECONOMY: 10, SOCIAL: 75, IMMIGRATION: 20, SECURITY: 42, ENVIRONMENT: 58, DEMOCRACY: 70, GLOBAL: 40, PUBLIC_SERVICES: 95 },
        description: { en: `Communist candidate. Maximum public services, pro-worker economy, more measured on immigration than LFI (laïcité focus), less anti-nuclear than Greens.`, fr: `Candidat communiste. Services publics maximaux, économie pro-travailleur, plus mesuré que LFI sur l'immigration (accent sur la laïcité), moins antinucléaire que les Verts.` },
      },
    ],
  },

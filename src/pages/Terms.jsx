      ...
      <div className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>Poliscope est édité par <strong>ALERY SASU</strong>, société par actions simplifiée, dont le siège social est situé 6 Rue René Schickelé, 67000 Strasbourg.</p>
          ...
          <section>
            ...
            <p>Poliscope est une plateforme en ligne permettant à ses utilisateurs de répondre à des questionnaires politiques afin d'obtenir un profil de positionnement politique indicatif, et de comparer ce profil à des candidats, figures historiques et archétypes politiques.</p>
            <p className="mt-2">L'utilisation de Poliscope est libre, gratuite et ne requiert pas de création de compte. La création d'un compte permet uniquement de sauvegarder et synchroniser votre profil entre appareils.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">3. Acceptation</h2>
            <p>L'accès et l'utilisation de Poliscope impliquent l'acceptation sans réserve des présentes CGU. Si vous n'acceptez pas ces conditions, vous devez cesser d'utiliser le service.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-900 mb-2">4. Nature des résultats</h2>
            <p className="mb-2">Les profils et scores produits par Poliscope sont <strong>indicatifs et non scientifiques</strong>. Ils sont calculés à partir de vos réponses à un questionnaire et ne constituent en aucun cas :</p>
            ...
            <p>Poliscope n'exprime aucune préférence pour un parti, un candidat ou une idéologie. Les données des candidats et figures politiques sont présentées à titre informatif et documentaire.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-2">Il est interdit d'utiliser Poliscope pour :</p>
          ...
          <section>
            ...
            <p className="mb-2">L'ensemble des éléments constitutifs de Poliscope — code source, design, textes, questions, algorithmes de scoring — sont la propriété exclusive de <strong>ALERY SASU</strong> et sont protégés par le droit de la propriété intellectuelle.</p>
          ...
          <section>
            ...
            <p>Poliscope est fourni "en l'état". Nous ne garantissons pas une disponibilité continue et ininterrompue. Des interruptions de service pour maintenance ou en cas de force majeure sont possibles sans préavis.</p>
          </section>
          ...
          <section>
            ...
            <p>Poliscope ne peut être tenu responsable des décisions — notamment électorales — prises sur la base des résultats du questionnaire.</p>
          </section>

...
const content = {
  en: {
    ...
    s4_items: [
      ...
      { heading: 'Your answers stay on your device', body: 'Your responses are stored in your browser\'s local storage. If cloud sync is enabled, an anonymous copy of your answers may also be sent to our servers, tied only to a random device ID — never to your name or email unless you choose to create an account. If you do create an account, your profile is saved to allow you to return to it — but it is never shared, sold, or used for any purpose other than your own convenience.' },
  ...
  fr: {
    ...
    s4_items: [
      ...
      { heading: "Vos réponses restent sur votre appareil", body: "Vos réponses sont stockées dans la mémoire locale de votre navigateur. Si la synchronisation cloud est activée, une copie anonyme de vos réponses peut aussi être envoyée à nos serveurs, associée uniquement à un identifiant d'appareil aléatoire — jamais à votre nom ou e-mail tant que vous n'avez pas créé de compte. Si vous créez un compte, votre profil est sauvegardé pour vous permettre d'y revenir — mais il n'est jamais partagé, vendu ou utilisé à d'autres fins." },

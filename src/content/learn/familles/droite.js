...
export default {
  ...
  level3: {
    sections: [
      {
        id: 'origines',
        sources: [{ label: `René Rémond, Les Droites en France, Aubier, 1982 (grille des trois droites)`, year: 1982 }],
      ...
      {
        id: 'vision-economie',
        sources: [{ label: `Vie-publique.fr — les privatisations de 1986-1988 et 1993-1995`, url: 'https://www.vie-publique.fr', year: 2025 }],
      ...
      {
        id: 'europe',
        sources: [{ label: `Résultats officiels du référendum du 20 septembre 1992 (Conseil constitutionnel) : « oui » 51,04 %`, url: 'https://www.conseil-constitutionnel.fr', year: 1992 }],
      ...
      {
        id: 'immigration',
        sources: [{ label: `Vie-publique.fr — chronologie des politiques d'immigration depuis 1945 (suspension de l'immigration de travail : décision de juillet 1974)`, url: 'https://www.vie-publique.fr', year: 2025 }],
      ...
      },
      {
        ...
        corps: {
          fr: `Trois débats traversent la droite en permanence. L'union des droites : faut-il s'allier avec la droite nationale pour gagner, ou maintenir une « digue » ? La question a fait exploser Les Républicains en 2024. Le rapport au centre : la droite libérale est proche du bloc macroniste — s'y fondre, c'est disparaître ; s'y opposer, c'est perdre des électeurs. Et le curseur économique : libéralisme assumé (moins d'impôts, moins de protections) ou protection des classes moyennes et populaires qui constituent désormais une grande partie de son électorat ?\n\nCes tensions ne sont pas des anomalies : elles reflètent les familles distinctes décrites plus haut. Pour la plupart des historiens des droites (Rémond, Sirinelli), l'unité idéologique durable de la droite française est restée l'exception : ce qui a surtout existé, ce sont des coalitions électorales plus ou moins longues — l'UMP des années 2000 étant la tentative d'unification la plus aboutie.`,
        },
      },
      {
        id: 'evolutions-historiques',
        sources: [{ label: `Gilles Richard, Histoire des droites en France (1815-2017), Perrin, 2017`, year: 2017 }, { label: `Résultats officiels de l'élection présidentielle 2002 (Conseil constitutionnel)`, url: 'https://www.conseil-constitutionnel.fr', year: 2002 }],
      ...
      },
      {
        ...
        corps: {
          fr: `Les Républicains (LR) — héritiers de la généalogie gaulliste RPF → UNR → UDR → RPR → UMP (2002) → LR (2015) ; affaiblis depuis 2017, scindés en 2024. Horizons (Édouard Philippe) et une partie de l'UDI — droite libérale et centriste compatible avec le bloc central. Debout la France (Dupont-Aignan) — droite souverainiste. Le Rassemblement national et Reconquête relèvent de la droite nationale, classée à l'extrême droite par la plupart des politistes (voir la section dédiée).\n\nEt Renaissance ? Le bloc présidentiel se définit comme central (« et de droite et de gauche »). Son classement fait débat parmi les politistes : plusieurs travaux le situent au centre-droit, surtout depuis 2022, au vu de ses politiques économiques et régaliennes ; d'autres maintiennent le classement au centre. Cette fiche n'arbitre pas — la fiche Renaissance détaillera les arguments des deux lectures, comme chaque fiche parti (généalogie, électorat, discours vs action au pouvoir).`,
        },
      },
      {
        id: 'critiques',
  ...
  chronologie: {
    ...
    events: [
      ...
      { date: '1992', titre: { fr: `Maastricht coupe la droite en deux` }, source: { label: `Conseil constitutionnel — proclamation des résultats du référendum, 23 septembre 1992`, year: 1992 }, detail: { fr: `Le référendum sur le traité de Maastricht (oui à ~51 %) fracture la droite : Philippe Séguin et Charles Pasqua mènent le « non » contre la ligne de leur propre camp. La fracture européenne ne s'est jamais refermée.` } },
      { date: '2002', titre: { fr: `L'UMP unifie la droite de gouvernement` }, source: { label: `Conseil constitutionnel — résultats de l'élection présidentielle 2002`, year: 2002 }, detail: { fr: `Après le choc du 21 avril (Jean-Marie Le Pen au second tour), la droite se rassemble dans l'UMP derrière Jacques Chirac, réélu avec 82 % des voix.` } },
      ...
      { date: '2024', titre: { fr: `La scission des Républicains` }, source: { label: `Vie-publique.fr — les élections législatives de 2024`, year: 2024 }, detail: { fr: `Le président de LR, Éric Ciotti, annonce une alliance avec le RN : le parti se déchire. L'épisode le plus récent du débat sur la frontière entre droite et extrême droite.` } },
    ],
  },
  ...
  tableauComparatif: {
    ...
    sources: [{ label: `Synthèse d'après René Rémond (1982) et Gilles Richard (2017)`, year: 2017 }],

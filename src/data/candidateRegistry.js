...
export const CANDIDATE_REGISTRY = [
  ...
  },
  {
    ...
    statusSourceIds: ['src-lfi-programme-2027-contributions', 'src-lcp-candidats-2027-2026-07-10'],
    trackedFor: ['fr_2027'], matchReady: false, profileSource: PROFILE_SOURCE.LEGACY_MANUAL_V1,
    programMaturity: 'M3', programSourceIds: ['src-lfi-programme-2027-contributions'], lastReviewed: '2026-08-10',
  },
  {
  ...
  // non sourcé », elles apparaissent à l'annuaire et jamais dans le classement.
  {
    ...
    statusSource: 'Candidature déclarée (Wikipédia — élection présidentielle française de 2027, consulté 2026-08-09) ; programme officiel structuré sur unenouvelleenergie.fr',
    statusSourceIds: ['src-wikipedia-presidentielle-2027', 'src-lisnard-programme-2027'],
    matchReady: false,

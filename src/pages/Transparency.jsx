  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Before starting the questionnaire, you can rank which topics matter most to you. If you mark the economy as your top priority, questions on that topic carry more weight in your final score. If you skip the ranking, topics are weighted in a fixed default order rather than equally — ranking them yourself gives a result that better reflects your real priorities.',
      },
    ],
    ...
    s4_items: [
      ...
      { heading: 'Your answers stay on your device', body: 'Your responses are stored in your browser\'s local storage — that\'s it, unless you choose otherwise. If you create an account, your answers and profile stay local-only until you explicitly agree to save them online — a separate, clear consent step, never bundled into account creation. Only after that agreement are your answers linked to your account and sent to our servers; you can withdraw that agreement or request deletion at any time.' },
  ...
  fr: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Avant de commencer le questionnaire, vous pouvez classer les sujets qui comptent le plus pour vous. Si vous indiquez l'économie comme votre priorité principale, les questions sur ce thème ont plus de poids dans votre score final. Si vous ignorez ce classement, les thèmes sont pondérés selon un ordre par défaut plutôt qu'à parts égales — les classer vous-même donne un résultat plus fidèle à vos priorités réelles.",
      },
    ],
    ...
    s4_items: [
      ...
      { heading: "Vos réponses restent sur votre appareil", body: "Vos réponses sont stockées dans la mémoire locale de votre navigateur — et rien de plus, sauf si vous en décidez autrement. Si vous créez un compte, vos réponses et votre profil restent uniquement locaux jusqu'à ce que vous acceptiez explicitement de les sauvegarder en ligne — une étape de consentement séparée, jamais intégrée à la création de compte. Ce n'est qu'après cet accord que vos réponses sont liées à votre compte et envoyées à nos serveurs ; vous pouvez retirer cet accord ou en demander la suppression à tout moment." },
